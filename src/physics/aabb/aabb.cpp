...
Intersection AABB::getIntersection(const AABB& other, const Vec3<f32>& moveDir) const {
...
Intersection AABB::getIntersection(const VoxelBlockWorld& blockWorld, const Vec3<f32>& moveDir) const {
